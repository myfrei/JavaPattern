...
import com.patterns.demo.patterns.behavioral.command.CommandDemoService;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.RequestMapping;
import org.springframework.web.bind.annotation.RestController;

@RestController
@RequestMapping("/api/patterns/behavioral/command")
public class CommandController {

    private final CommandDemoService service;

    public CommandController(CommandDemoService service) {
