...
import com.patterns.demo.patterns.behavioral.mediator.MediatorDemoService;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.RequestMapping;
import org.springframework.web.bind.annotation.RestController;

@RestController
@RequestMapping("/api/patterns/behavioral/mediator")
public class MediatorController {

    private final MediatorDemoService service;

    public MediatorController(MediatorDemoService service) {
